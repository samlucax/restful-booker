define({ "api": [
  {
    ...
    "examples": [
      {
        "title": "Example 1:",
        "content": "curl -X POST \\\n  https://treinamento-api.herokuapp.com/auth \\\n  -H 'Content-Type: application/json' \\\n  -d '{\n    \"username\" : \"admin\",\n    \"password\" : \"password123\"\n}'",
        "type": "json"
      }
    ],
    "success": {
    ...
    "examples": [
      {
        ...
        "content": "curl -i https://treinamento-api.herokuapp.com/booking/1",
        "type": "json"
      }
    ],
    "success": {
    ...
    "examples": [
      {
        ...
        "content": "curl -i https://treinamento-api.herokuapp.com/booking",
        "type": "json"
      },
      {
        "title": "Example 2 (Filter by name):",
        "content": "curl -i https://treinamento-api.herokuapp.com/booking?firstname=sally&lastname=brown",
        "type": "json"
      },
      {
        "title": "Example 3 (Filter by checkin/checkout date):",
        "content": "curl -i https://treinamento-api.herokuapp.com/booking?checkin=2014-03-13&checkout=2014-05-21",
        "type": "json"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Ping server:",
        "content": "curl -i https://treinamento-api.herokuapp.com/ping",
        "type": "json"
      }
    ],
    "success": {
